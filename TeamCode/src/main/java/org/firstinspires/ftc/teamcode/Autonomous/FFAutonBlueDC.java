...
@Autonomous
public class FFAutonBlueDC extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.MoveRobotToPosition(0.5, 1.5);
        robot.MoveRobotToPositionStrafeRight(0.3, -9);
        //deliver the duck
        ...
        robot.MoveRobotToPosition(0.5, -11.75);
    }
}