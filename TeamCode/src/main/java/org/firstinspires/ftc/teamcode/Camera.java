...
public class ConceptTensorFlowObjectDetectionWebcam extends LinearOpMode {
     ...
     */
    private static final String TFOD_MODEL_ASSET = "GreenCone_model.tflite";
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            ...
                            if (recognition.getLabel() == "green_TSE"){
                                Xvalue = recognition.getRight();

                                if(Xvalue <= 150){
                                    telemetry.addData("TSE position", "left");
                                    telemetry.addData("Hub level", "1");}
                                   else if (Xvalue >= 400){
                                        telemetry.addData("TSE position",  "right");
                                        telemetry.addData("hub level", "3");}
                                        else {
                                            telemetry.addData("TSE position", "middle");
                                            telemetry.addData("hub level", "2");}
                                    }
                                }
                            }
