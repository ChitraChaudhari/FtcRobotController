...
@Autonomous
public class FFAutonRedDC extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.MoveRobotToPosition(0.5, 2);
        robot.pointTurn(-57, 0.3);
        ...
        robot.pointTurn(22, 0.3);

        //Move robot to shipping hub
        if (result == LEFT) {
            robot.MoveRobotToPosition(0.3, 15.75);
        } else if (result == MIDDLE) {
            robot.MoveRobotToPosition(0.3, 13.25);
        } else if (result == RIGHT) {
            robot.MoveRobotToPosition(0.3, 13);
        } else {
        ...
        robot.pointTurn(-25, 0.5);
        robot.MoveRobotToPosition(0.5, -11.5);
    }
}
