...
@Autonomous
public class FFAutonBlueDC_GYRO extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.MoveRobotToPositionStrafeRight(0.3, -9.55);
        //deliver the duck
        robot.carouselMotor.setPower(0.25);
        sleep(4000);
        robot.carouselMotor.setPower(0);

        //Turn robot so the front of robot points to shipping huby
        robot.turnPID(45);
        ...
        if (result == LEFT) {
            ...
            robot.MoveRobotToPosition(0.3, 13.50);
        } else if (result == RIGHT) {
        ...
        robot.turnPID(35);
        robot.MoveRobotToPosition(0.5, -11);
    }
}